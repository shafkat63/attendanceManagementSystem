            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                                <h5 class="card-title">Nav Sidebar</h5>
                            </div>
                            <div class="col-md-2 mt-3 ">
                                <a href="{{route('SidebarNav.create')}}" type="button" class="btn btn-outline-success btn-sm text-right"> Add New <i class="bi bi-plus"></i></a>
                            </div>
                        </div>
...
@section('script')
    <script>
                ...
                columns: [
                    { data: 'id' },
                    {
                        ...
                        render: function(data, type, row) {
                            // Indent child rows
                            let indent = row.parent_id ? 'padding-left: 50px;' : '';
                            return `<div style="${indent}">${data}</div>`;
                        }
                    },
                    { data: 'order' },
                    {
        ...
        function showData(id) {
            var url = "{{ route('SidebarNav.edit', ':id') }}"; // Use named route with placeholder
